...
<body style="background-color:#f1f2f4;height:calc(200%-225px);">
...
<div class="cont">
   <div class="log" >Get your free account </div>
	 ...
	 <br>
	  <div class="input-icons">
	    <input type="text" class="textbox" name="text" placeholder="Work email address">
		<i class="fa fa-envelope icon"></i>
	 </div>
	 
	   <button class="mybtn" type="submit" name="submit" value="Continue with Email" onclick="window.location.href='signupdetails.php'">Continue with Email</button>
