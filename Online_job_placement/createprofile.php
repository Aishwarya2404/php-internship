...
<script>
  function tickcolorchg()
  {
	    document.getElementById("fid").style.color="green";
		document.location.href="createprofile2.php";
  }
</script>
<meta charset="utf-8">
...
<body style="background-color:#f1f2f4;width:100%;">
  ...
  <div class="left-tab">
	  ...
	  <div style="margin-bottom:15px">
		  ...
		  <i id="fid" class="fa fa-check-circle" style="right:20px;position:absolute;margin-top:9px"></i>
	   </div>
	   <div style="margin-bottom:15px">
    ...
    <div class="card" id="maincard">
	   <div class="uppercard">
	       <img src="images/mynewcoder.jpg" width="570px" height="200px" style="margin-left:40px;margin-top:25px"></img>
	   </div> 
	      <div class="mytext">Join Upwork as a freelancer</div><br>
		  <div class="mytext2">Hi Aishwarya</div><br>
		  <div class="mytext2">Thanks for your intrest in Upwork!As the world's largest talent platform ,we connect millions   of bussinesses with independent professionals like you.</div>
		  <br><div class="mytext2">To get started,all you need to do is fill out a profile.</div><br>
		  <div class="mytext2"><a href="#">Not a freelancer?</a> 
		     <Button class="mybtn" onclick="tickcolorchg()">Continue</button>
		  </div><br>
   </div>
   
    <div class="cardcategory" id="categorycard">
    ...
    <div class="startedcard" id="startedcard">
	      ...
	      <div class="mytextnew">Getting Started</div><hr/>
		  <div class="mytextneww">How would you like to fill out your profile?.</div><br>
		  <div class="mytextnew2">To speed this up,upload a PDF of your Linkdin pofile .You can edit it after importing.</div>
		 
		     <Button class="mybtncat" onclick="">Fill out anually</button>
     </div>		  
